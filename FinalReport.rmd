...
The drug has shown to be effective after looking at the results of the tests we ran. For example the Fisher Test shows that in a one to one ratio it would be very unlikely for one to be diagnosed with AIDs. 
